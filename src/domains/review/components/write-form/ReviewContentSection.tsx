...
export function ReviewContentSection({
  ...
  return (
    <div>
      <label className={`block text-sm font-medium mb-2 ${validationErrors.content ? 'text-red-600' : 'text-gray-700'}`}>
      ...
      <div className="flex items-center justify-between mt-1">
        <span className={`text-xs ${validationErrors.content ? 'text-red-500' : 'text-gray-500'}`}>
