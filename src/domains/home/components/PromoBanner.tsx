...
export const PromoBanner = React.memo(function PromoBanner({ 
  ...
  return (
    <div className={`relative overflow-hidden rounded-2xl bg-gradient-to-r ${currentBanner.gradient} text-white p-8 h-[260px] ${className}`}>
      {/* 배경 패턴 */}
          ...
          <div className="flex justify-center pb-4 space-x-2">
            {banners.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-colors cursor-pointer hover:bg-white/70 ${
