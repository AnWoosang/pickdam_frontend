...
import { Product, SortBy, SortOrder, ProductCategory, MainCategory, CATEGORY_CONFIG, getProductCategoriesForMain, InhaleType, INHALE_TYPE_CONFIG } from '@/types/product';
